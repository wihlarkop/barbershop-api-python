...
transaction = Table(
	...
	ForeignKeyConstraint(
		name="fk_transaction_user", columns=["user_uuid"], refcolumns=["user.uuid"]
	),
	ForeignKeyConstraint(
		name="fk_transaction_store", columns=["store_uuid"], refcolumns=["store.uuid"]
	),
	ForeignKeyConstraint(
		name="fk_transaction_capster",
		columns=["capster_uuid"],
		refcolumns=["user.uuid"],
	),
	ForeignKeyConstraint(
		name="fk_transaction_product",
		columns=["product_uuid"],
		refcolumns=["product.uuid"],
	),
)
